...
* **KMZ to CSV:** Extracts specific placemark info from a KMZ, reformats it to CSV. Intended to be used with ImportGeoCSV (included in lisp files in this repo) to place geolocated objects in AutoCAD. See below for a real-time demonstration of the routine in action



https://github.com/user-attachments/assets/f9f9b95f-8e8d-44ca-b19a-34f14ff05ba7
